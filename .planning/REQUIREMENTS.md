...
- [ ] **FEED-01**: User sees viral recipes trending within a 5-10 mile radius of their location
...
- [ ] **FEED-07**: User's location is shown at the top of the feed (city badge)
- [ ] **FEED-08**: User can manually change their location to explore other areas
