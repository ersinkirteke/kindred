...
- [x] **FEED-02**: Each recipe card displays AI-generated hero image, recipe name, prep time, calories, and "loves this week" count
...
- [x] **FEED-09**: Feed loads cached content when offline with clear offline indicator
...
| FEED-02 | Phase 2, Phase 9 | Complete |
